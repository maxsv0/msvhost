    ...
    <div class="col-sm-10 col-sm-offset-1">
        ...
        <table class="table table-highlight" id="table_warch">
            ...
            <tr>
                ...
                <td class="text-center" onclick="table_architecture(1);"><span class="label label-success">admin</span> access level</td>
                <td class="text-center" onclick="table_architecture(2);"><span class="label label-success">dev</span> access level</td>
            </tr>
            <tr>
                <td class="table-title">Subdomain .msvhost.com</td>
                <td class="text-center" onclick="table_architecture(1);"><b>Yes</b></td>
                <td class="text-center" onclick="table_architecture(2);"><b>Yes</b></td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td class="text-center" onclick="table_architecture(1);"><b>Yes</b></td>
                <td class="text-center" onclick="table_architecture(2);">No</td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td class="text-center" onclick="table_architecture(1);">No</td>
                <td class="text-center" onclick="table_architecture(2);"><b>Yes</b></td>
            </tr>
            <tr>
